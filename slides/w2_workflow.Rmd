...
*go [here](https://uo-datasci-specialization.github.io/c1-intro-fall-2021/data_list.html) to download*
...
```{r}
import("https://raw.githubusercontent.com/uo-datasci-specialization/c1-intro-fall-2021/master/data/Fatality.txt",
       setclass = "tbl_df")
```
...
2. .darkblue[Where] to export it?

.darkorange[`export`]`(`.green[`x`]`,` .darkblue[`file`]`,` .pink[`format`]`, ...)`
...
.darkorange[`write_csv`]`(`.green[`x`]`,` .darkblue[`file`]`, ...)`
...
(2) Read in the [Penguins.csv](https://uo-datasci-specialization.github.io/c1-intro-fall-2021/data_list.html) data
...
```{r, eval=FALSE}
slice(arrange(select(filter(penguins, species == "Adelie", bill_length_mm > 40), island, bill_length_mm, body_mass_g), bill_length_mm), 1:3)
```
...
Script on website
* Download **Homework 1** from the course [Schedule](https://uo-datasci-specialization.github.io/c1-intro-fall-2021/schedule.html) or [Assignments](https://uo-datasci-specialization.github.io/c1-intro-fall-2021/assignments.html) page
* Work with this .Rmd file

Submit a rendered .html file to Canvas
* *Assignments > Homeworks > HW 1*

You **may** need to install [`{tinytex}`](https://yihui.name/tinytex/) to get your .Rmd file to render to an .html file
...
* Supplemental Learning
  ...
  + [Codecademy: Introduction to Visualization with R](https://www.codecademy.com/courses/learn-r/lessons/intro-visualization-ggplot2-r/exercises/introduction)
* Homework
  + **Homework 1**
* Final project
...
```{r, eval=FALSE}
xaringanBuilder::build_pdf(here::here("slides", "w2_workflow.Rmd"), complex_slides = TRUE)
```