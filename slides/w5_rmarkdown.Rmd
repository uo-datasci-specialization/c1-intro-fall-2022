...
---
### UO Libraries’ Statistical Consulting Service

* The [UO Libraries’ Statistical Consulting Service](https://library.uoregon.edu/research-data-management/consultations), for graduate and undergraduate students, is available this term Monday - Friday 11 am - 4 pm on the first floor of the Knight Library (towards the back to the right of the main staircase). We are also available for scheduled to answer your questions and set up [appointments via our website](https://library.uoregon.edu/research-data-management/consultations). Anyone looking for help with statistics, statistical software like R, SPSS, Python, research design, GIS, git/GitHub and qualitative software such as Dedoose should get in touch with us using the links above. 

* The library also offers free short [workshops](https://uoregon.libcal.com/calendar/dataservices/?cid=11979&t=d&d=0000-00-00&cal=11979,5245,11173,15812,6522&inc=0using) on topics such as R, Python, surveys, organizing your research data, qualitative research (Dedoose), creating a personal or lab website, using Zotero to manage your citations, and more. Our Friday lunch chats ([Coffee + Data & Code](https://uoregon.libcal.com/event/8301992) and [Book Club](https://uoregon.libcal.com/event/8304838)) offer a great opportunity to meet folks interested in data and code from across the university.

* Saturday, Nov. 6th they are offering an all-day Python intensive.
...
xaringanBuilder::build_pdf(here::here("slides", "w6_rmarkdown.Rmd"), complex_slides = TRUE)
```
