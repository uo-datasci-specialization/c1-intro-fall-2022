...
* See [syllabus](https://uo-datasci-specialization.github.io/c1-intro-fall-2021/syllabus.html#UO_COVID-19_Regulations__Prevention) for related policies
...
### with `{blogdown}`, `{distill}`, `{bookdown}`, `{rmarkdown}`
