...
2.1. Download the *studentInfo.csv*, *studentAssessment.csv*, and *assessments* data from the [course website](https://uo-datasci-specialization.github.io/c1-intro-fall-2021/data_list.html).
